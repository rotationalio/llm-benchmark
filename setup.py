...
## Basic Information
NAME = "construe"
DESCRIPTION = "An LLM inferencing benchmark tool focusing on device-specific latency and memory usage"  # noqa
...
if __name__ == "__main__":
    config = {
        ...
        "entry_points": {
            "console_scripts": [
                "construe = construe.__main__:main",
            ]
        },
